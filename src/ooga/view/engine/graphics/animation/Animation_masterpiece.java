...
/**
 * the class extracted and implemented the shared animation mechanism for both 2D and 3D,
 * which includes the implementation of updating the location of the frame pointer according to the timer,
 * resetting the animation after its completion, and so on.
 * @author qiaoyi fang
 **/
abstract public class Animation_masterpiece {
  ...
  public Animation_masterpiece(int cnt, int fps){
    resetAnimation();
    this.fps = 1.0 / fps;
